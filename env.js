...
//网站标题
dctitle = "灵阁实验室-SpinberLab";

//网站关键字，用空格分隔
keywords = "灵阁实验室 SpinberLab";

//网站介绍
descrp = "灵阁实验室——线上全行业交流";
...
contacts = [
  [
    "fab fa-qq",
    "QQ群",
    "点击链接加入群聊【灵阁聊天室 | 全行业聊天线上平台】：https://qm.qq.com/q/vZ5XyOdJEA"
  ],
  [
    "fab fa-google",
    "邮箱",
    "mailto:3941295623@qq.com"
  ]
];
...
memb = [
  [
    ...
    "./images/主核kernel.jpg",
    "主核kernel",
    "创新是我基因的一部分-多技术潜能者，主人公性格，曾设计过6个网站前端，独立开发过神奇海螺AI对话平台，正式开发过3个独立游戏",
    [
      "917811726",
  ...
  [
    "./images/backgroud.jpg",
    "./images/pigcanfly.jpg",
    "Pigcanfly",
    "网络安全爱好者-Web手转二进制，以前10余枚低危至高危漏洞（垃圾洞来的）目前在嗑C语言",
    [
      "2497089688",
      "spinberlab.github.io",
      "pigcanfly66@gmail.com"
    ]
  ]
];
